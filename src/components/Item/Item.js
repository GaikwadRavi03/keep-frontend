...
class Item extends Component {
    ...
    render() {
        ...
        const { show, archive, bin, title, task, gridView, editNote, isEdit, editTitle, editTask, inputHandler, submitHandler, archiveHandler, unArchiveHandler, restoreHandler, deleteHandle } = this.props
